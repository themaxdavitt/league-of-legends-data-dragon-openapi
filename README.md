# League of Legends Data Dragon OpenAPI Definition

This was painful. Hope it's helpful. I know it's incomplete, open a PR if you want to help.

Project generated with [`create-openapi-repo`](https://github.com/Redocly/create-openapi-repo).
